...
<?php 
    ...
    /*----include the database conection----*/  
      include_once("uni/db_connect.php");
       ...
       echo "<h1 id='category' style='display:none;'>" .$category. "</h1>"; 
?>
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"> 
     ...
     <link rel="stylesheet" href="css/content_category.css">
 ...
 <div id="page">
  ...
  <div class="content">
      <div class="content_presentation">
       <?php
        $query="SELECT * FROM posts WHERE Post_Category='$category' ORDER BY Post_Date DESC LIMIT 3";
          ...
          { 
            ...
            <div class="presentation">
              ...
              <div class="txt_presentation">
               <h2 id="post_category">' .$category. ' </h2>
               <a href=" '.$link.'"><h3 class="post_title">'  .$title. '</h3></a>
              <span> By:' .$author. '&nbsp Date:' .$date. '</span>
            </div>
            </div>';
          }
        ?>  
   ...
   <h2 id="category_title"> <?php echo "$category  Posts"; ?></h2>
   <div class="last_articles_category">
   <?php
              $query="SELECT * FROM posts WHERE  Post_Category='$category'";
              $result=mysqli_query($connect, $query);
            ...
            $query = "SELECT *FROM posts WHERE  Post_Category='$category' ORDER BY Post_Date DESC LIMIT " . $page_first_result . ',' . $results_per_page; 
            ...
            echo '
            <div class="last_articles_posts_category">
            <a href=" '.$link.'"><img src=" '.$img_src.'"> </a>
            <h4 id="post_category_post">' .$category. ' </h4>
             <a href=" '.$link.'"><h5 id="post_title">'  .$title. '</h5></a>
            <span> By:' .$author. '&nbsp Date:' .$date. '</span>
            <h6>' .$content. '</h6>
            </div>';
            }
  ...
  <script type="text/javascript" src="js/category_style.js"></script>
